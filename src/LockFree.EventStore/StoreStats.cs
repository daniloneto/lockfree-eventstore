...
/// </summary>
public readonly struct StoreStats
{
    /// <summary>
    /// Total number of successful append operations since store creation.
    /// </summary>
    public long AppendCount { get; init; }
    ...
    /// </summary>
    public long SnapshotBytesExposed { get; init; }
    ...
    /// </summary>
    public long WindowAdvanceCount { get; init; }

    /// <summary>
    /// Creates a new instance of StoreStats with the specified values.
    /// </summary>
    public StoreStats(long appendCount, long droppedCount, long snapshotBytesExposed, long windowAdvanceCount)
    {
        AppendCount = appendCount;
        DroppedCount = droppedCount;
        SnapshotBytesExposed = snapshotBytesExposed;
        WindowAdvanceCount = windowAdvanceCount;
    }
