...
internal sealed class PaddedPartitionHeaders
{
    ...
    /// </summary>
    private int GetPaddedIndex(int partitionIndex)
    {
    ...
    /// </summary>
    public HeaderEnumerator GetEnumerator() => new HeaderEnumerator(this);
    ...
    public ref struct HeaderEnumerator
    {
        ...
        public ref PartitionHeader Current => ref _headers.GetHeader(_currentIndex);
    }
}
